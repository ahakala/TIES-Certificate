...
==================== Changes Made By TIES ================================
At the moment, these files may be overwritten when we upgrade the certificate module. IF this happens, put these files back in. 

My extra files are:
certificate-> pix -> borders -> TIES.jpg
certificate-> pix -> signatures -> (all the files)
certificate-> type-> TIES_WORKSHOP
